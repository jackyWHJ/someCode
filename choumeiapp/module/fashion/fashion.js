...
define(['jquery', 'commonUtils'], function($, commonUtils){
    ...
    var equipmentCenter = function( id ){
        ...
        var page = {
            ...
            template: function( data ){
                $(".equipment-name").text(data.equipmentSlogan);

                var html = '', img = '<section class="grid-block">';

                $.map( data.contents , function(object, key){
                ...
                $(".equipment-address").append( html );

            },
            render: function( id ){

                commonUtils.request({
                    url: apiConfig.newApi + 'beauty/item-equipment.html',
                    data :{itemId: id},
